                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select id="event_type" 
                                    ...
                                    <option value="physical" {{ old('event_type', $event->event_type) == 'physical' ? 'selected' : '' }}>Physical - In-person event</option>
                                    <option value="online" {{ old('event_type', $event->event_type) == 'online' ? 'selected' : '' }}>Online - Virtual event</option>
                                    <option value="hybrid" {{ old('event_type', $event->event_type) == 'hybrid' ? 'selected' : '' }}>Hybrid - Both in-person and online</option>
                                </select>
                                @error('event_type')
                                    <p class="form-error">{{ $message }}</p>
                                @enderror
                    ...
                    <div class="border-t border-gray-200 pt-6">
                        ...
                        <div>
                            ...
                            <label for="featured_image" class="form-label">
                                {{ $event->featured_image ? 'Replace Image' : 'Upload Image' }} <span class="text-gray-500 text-sm font-normal">(Optional)</span>
                            </label>
                            <input type="file" 
                                   id="featured_image" 
                                   name="featured_image" 
