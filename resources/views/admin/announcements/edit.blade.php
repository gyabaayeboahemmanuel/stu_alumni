                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea id="excerpt" 
                                          ...
                                          placeholder="Brief summary of the announcement (max 500 characters)">{{ old('excerpt', $announcement->excerpt) }}</textarea>
                    ...
                    <div class="border-t border-gray-200 pt-6">
                        ...
                        <div>
                            ...
                            <label for="featured_image" class="form-label">
                                {{ $announcement->featured_image ? 'Replace Image' : 'Upload Image' }} 
                            ...
                            <div id="imagePreview" class="mt-4 hidden">
                                ...
                                <img id="previewImg" src="" alt="Preview" class="max-w-xs rounded-lg shadow-md mt-2">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <select id="visibility" 
                                        ...
                                        required>
                                    <option value="public" {{ old('visibility', $announcement->visibility) == 'public' ? 'selected' : '' }}>Public - Visible to everyone</option>
                                    <option value="alumni" {{ old('visibility', $announcement->visibility) == 'alumni' ? 'selected' : '' }}>Alumni Only - Visible to registered alumni only</option>
                                </select>
                                @error('visibility')
                                    <p class="form-error">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea id="meta_description" 
                                          ...
                                          maxlength="500">{{ old('meta_description', $announcement->meta_description) }}</textarea>
