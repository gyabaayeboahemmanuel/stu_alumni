...
@section('title', 'Create Year Group')
    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center mb-4">
                ...
                <h1 class="text-3xl font-bold text-gray-900">Create Year Group</h1>
            </div>
            <p class="text-gray-600">Create a new year group for alumni to connect</p>
        </div>

        <!-- Form -->
        <form action="{{ route('admin.year-groups.store') }}" method="POST">
            @csrf
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       placeholder="e.g., The 2010s Cohort"
                                       required>
                                @error('name')
                            ...
                            <div>
                                ...
                                <textarea id="description" 
                                          ...
                                          placeholder="Brief description of this year group">{{ old('description') }}</textarea>
                                @error('description')
                                    <p class="form-error">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="mt-4 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                            <div class="flex items-start">
                                ...
                                <div class="text-sm text-yellow-800">
                                    <p class="font-medium">Tips for Group Links:</p>
                                    <ul class="mt-2 space-y-1 list-disc list-inside">
                                        <li>Use invite links that don't expire</li>
                                        <li>You can add links later if groups aren't set up yet</li>
                                        <li>Alumni will see a "Join Group" button for each link you provide</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                ...
                <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex justify-end space-x-3">
                    ...
                    <button type="submit" class="btn-primary">
                        <i class="fas fa-save mr-2"></i>Create Year Group
                    </button>
                </div>
            </div>
        </form>
